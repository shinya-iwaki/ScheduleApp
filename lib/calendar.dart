...
import 'package:flutter_schedule/calendar_model.dart';
import 'package:flutter_schedule/db.dart';
      ...
      child: Container(
          ...
          child: Row(
              ...
              children:[Text(d,
                ...
                IconButton(icon: FaIcon(FontAwesomeIcons.trashAlt, color: Colors.blueAccent, size: 15,), onPressed: ()=> _deleteEvent(d))
              ]) ),
    );  }
    ...
    return Container(
        ...
        child: TableCalendar(
          ...
          calendarStyle: CalendarStyle(
            ...
            todayStyle: TextStyle(color: Colors.blueAccent, fontSize: 15, fontWeight: FontWeight.bold),
  ...
  Widget eventTitle(){
    if(_selectedEvents.length == 0){
      return Container(
        ...
        child:Text("スケジュールはありません", style: Theme.of(context).primaryTextTheme.headline1),
      );
    }
    return Container(
      padding: EdgeInsets.fromLTRB(15, 20, 15, 15),
      child:Text("スケジュール", style: Theme.of(context).primaryTextTheme.headline1),
    );
  }
